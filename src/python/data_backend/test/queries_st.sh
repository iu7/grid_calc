...
curl localhost:50001/data/mtm_traitagent/filter  -X GET    -H "Content-Type: application/json" -d '{"value":{"agent_id":"1", "trait_id":"2"}}'; echo
curl localhost:50001/data/mtm_traitagent/filter  -X DELETE -H "Content-Type: application/json" -d '{"value":{"agent_id":"1", "trait_id":"2"}}'; echo
curl localhost:50001/data/mtm_traitagent/filter  -X GET    -H "Content-Type: application/json" -d '{"value":{"agent_id":"1", "trait_id":"2"}}'; echo
