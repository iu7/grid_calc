...
\subsubsection{Фронтэнд пользователей}

\subsubsection{Фронтэнд вычислительных узлов}

\subsubsection{Система управления сессией}

\subsubsection{Система управления}

\subsubsection{Система хранения данных}

\subsubsection{Система балансировки нагрузки}

\subsubsection{Система вычисления}
